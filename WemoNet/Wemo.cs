...
namespace WemoNet
{
    public class Wemo
    {
        ...
        public async Task<T> GetWemoResponseObjectAsync<T>(Soap.WemoGetCommands cmd, string ipAddress)
        {
            ...
            {
                var plug = new WemoInsightPlug { WebRequest = this.WebRequest };
        ...
        public async Task<WemoInsightParams> GetInsightParams(string ipAddress)
        {
            var result = await GetWemoResponseObjectAsync<GetInsightParamsResponse>(Soap.WemoGetCommands.GetInsightParams, ipAddress);
            return new WemoInsightParams(result);
        }
